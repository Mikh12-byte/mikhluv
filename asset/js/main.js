...
$(document).on("click", "#tombolPopup", function (e) {
  ...
  Swal.fire({
    icon: "info",
    title: "Halo Jodoh Orang",
    text: "Aku mau nanya sedikit nih ke kamu",
    showClass: {
    ...
    Swal.fire({
      title: "Please Jawab yang jujur ya",
      showClass: {
      ...
      Swal.fire({
        ...
        Swal.fire({
          title: "Kamu mau aku panggil siapa?",
          showClass: {
            popup: "animate__animated animate__jackInTheBox",
          },
          hideClass: {
                ...
                Swal.queue([
                  {
                    ...
                    preConfirm: function (value) {
                      Swal.insertQueueStep({
                        title:
                          "Makasih loh sudah sayang ke aku😘😘😘" +
                          " " +
                          value +
                          "%",
                        icon: "info",
                    ...
                    Swal.queue([
                      {
                        ...
                        confirmButtonText: "Submit",
                        showCancelButton: true,
                        text: "aku pengen tau seberapa sayang kamu ke aku",
                        showClass: {
                          popup: "animate__animated animate__jackInTheBox",
                        },
                        hideClass: {
